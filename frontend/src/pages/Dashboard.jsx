...
//   // SCORE COLORS (0-7 scale)
//   const getScoreClass = (score) => {
//     if (score >= 5) return "score high";   // 5-7: Good (Green)
//     if (score >= 2) return "score mid";    // 2-4: Medium (Orange)
//     return "score low";                     // 0-1: Low (Red)
//   };
...
//                     <td>
//                       <span className={getScoreClass(row["Score"])}>
//                         {row["Score"]}
//                       </span>
//                     </td>
...
export default function Dashboard() {
  ...
  const updateCell = async (
    ...
    try {
      ...
      await axios.post(
        "http://127.0.0.1:8000/update-cell",
        {
          row: sheetRow,
          col,
          value,
